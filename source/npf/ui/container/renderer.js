 ...
 * @deprecated Use npf.ui.StatedRenderer.
 */
npf.ui.container.Renderer = function() {
  goog.base(this);
};
goog.inherits(npf.ui.container.Renderer, npf.ui.renderComponent.Renderer);
goog.addSingletonGetter(npf.ui.container.Renderer);


/**
 * @type {string}
 */
npf.ui.container.Renderer.CSS_CLASS = goog.getCssName('npf-container');
 ...
 * @private
 */
npf.ui.container.Renderer.ARIA_STATE_MAP_;

/**
 * @param {Function} ctor
 * @param {string} cssClassName
 * @return {npf.ui.container.Renderer}
 */
npf.ui.container.Renderer.getCustomRenderer = function(ctor, cssClassName) {
...
/** @inheritDoc */
npf.ui.container.Renderer.prototype.getCssClass = function() {
  return npf.ui.container.Renderer.CSS_CLASS;
};
...
/**
 * @param {!npf.ui.RenderComponent} component Component to render.
 * @return {Element} Root element for the component.
 * @override
 */
npf.ui.container.Renderer.prototype.createDom = function(component) {
  var element = /** @type {!Element} */ (goog.base(this, 'createDom', component));
  this.setAriaStates(/** @type {!npf.ui.Container} */ (component), element);
...
/**
 * Default implementation of {@code decorate} for {@link npf.ui.Container}s.
 ...
 */
npf.ui.container.Renderer.prototype.decorate = function(component, element) {
...
/**
 * Initializes the component's DOM by configuring properties that can only be set
 * after the DOM has entered the document.  This implementation sets up BiDi
 * and keyboard focus.  Called from {@link npf.ui.Container#enterDocument}.
 * @param {npf.ui.Container} component Component whose DOM is to be initialized
 *     as it enters the document.
 */
npf.ui.container.Renderer.prototype.initializeDom = function(component) {
 ...
 * will be set.
 * @param {!npf.ui.Container} component Component whose ARIA state will be updated.
 * @param {!Element} element Element whose ARIA state is to be updated.
 */
npf.ui.container.Renderer.prototype.setAriaStates = function(component, element) {
 ...
 */
npf.ui.container.Renderer.prototype.setAllowTextSelection = function(element,
    allow) {
 ...
 *     right-to-left.
 */
npf.ui.container.Renderer.prototype.setRightToLeft = function(element,
                                                              rightToLeft) {
 ...
 * @param {npf.ui.Container} component Component whose key event target is to be
 *     checked.
 * @return {boolean} Whether the component's key event target is focusable.
 */
npf.ui.container.Renderer.prototype.isFocusable = function(component) {
  var keyTarget;
...
/**
 * Updates the component's key event target to make it focusable or non-focusable
 * via its {@code tabIndex} attribute.  Does nothing if the component doesn't
 ...
 */
npf.ui.container.Renderer.prototype.setFocusable = function(component, focusable) {
  var keyTarget;
  ...
  if (
    ...
    if (!focusable && component.isFocused()) {
      ...
      // was called on it should have been handled by the component's handleBlur()
      // method, so at this point the component should no longer be focused.
 ...
 */
npf.ui.container.Renderer.prototype.setVisible = function(element, visible) {
 ...
 * @param {npf.ui.Container} component Component instance to update.
 * @param {goog.ui.Component.State} state State to enable or disable.
 * @param {boolean} enable Whether the component is entering or exiting the state.
 */
npf.ui.container.Renderer.prototype.setState = function(component, state,
                                                        enable) {
 ...
 * @protected
 */
npf.ui.container.Renderer.prototype.updateAriaState = function(element, state,
                                                               enable) {
 ...
 * focus (null if none).  The default implementation returns the component's root
 * element.
 * @param {npf.ui.Container} component Component whose key event target is to be
 *     returned.
 * @return {Element} The key event target.
 */
npf.ui.container.Renderer.prototype.getKeyEventTarget = function(component) {
 ...
 * @param {npf.ui.RenderComponent} component Component whose CSS classes are to be
 *     returned.
 * @return {Array.<string>} Array of CSS class names applicable to the component.
 * @protected
 */
npf.ui.container.Renderer.prototype.getClassNames = function(component) {
  /** @type {Array.<string>} */
 ...
 * @protected
 */
npf.ui.container.Renderer.prototype.getClassNamesForState = function(state) {
  var classNames = [];
 ...
 * @protected
 */
npf.ui.container.Renderer.prototype.getClassForState = function(state) {
 ...
 * @protected
 */
npf.ui.container.Renderer.prototype.getStateFromClass = function(className) {
 ...
 * @private
 */
npf.ui.container.Renderer.prototype.createClassByStateMap_ = function() {
  /**
 ...
 * @private
 */
npf.ui.container.Renderer.prototype.createStateByClassMap_ = function() {
 ...
 * @return {string}
 */
npf.ui.container.Renderer.prototype.getDisabledCssClass = function() {
 ...
 * @return {string}
 */
npf.ui.container.Renderer.prototype.getHoverCssClass = function() {
 ...
 * @return {string}
 */
npf.ui.container.Renderer.prototype.getActiveCssClass = function() {
 ...
 * @return {string}
 */
npf.ui.container.Renderer.prototype.getSelectedCssClass = function() {
 ...
 * @return {string}
 */
npf.ui.container.Renderer.prototype.getCheckedCssClass = function() {
 ...
 * @return {string}
 */
npf.ui.container.Renderer.prototype.getFocusedCssClass = function() {
 ...
 * @return {string}
 */
npf.ui.container.Renderer.prototype.getOpenCssClass = function() {
 ...
 * @return {string}
 */
npf.ui.container.Renderer.prototype.getRtlCssClass = function() {
