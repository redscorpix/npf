...
/**
 * Base class for UI components.  Extends {@link npf.ui.RenderComponent} by adding
 * the following:
 *  <ul>
 ...
 *  </ul>
 * This class has sufficient built-in functionality for most simple UI components.
 * All components dispatch SHOW, HIDE, ENTER, LEAVE, and ACTION events on show,
 * hide, mouseover, mouseout, and user action, respectively.  Additional states
 * are also supported.
 * for example usage.
 * @param {npf.ui.container.Renderer=} opt_renderer Renderer used to render or
 *     decorate the component; defaults to {@link npf.ui.container.Renderer}.
 * @param {goog.dom.DomHelper=} opt_domHelper Optional DOM helper, used for
 *     document interaction.
 * @constructor
 * @extends {npf.ui.RenderComponent}
 * @deprecated Use npf.ui.StatedComponent.
 */
npf.ui.Container = function(opt_renderer, opt_domHelper) {
  goog.base(this, opt_renderer || npf.ui.container.Renderer.getInstance(),
    opt_domHelper);
};
goog.inherits(npf.ui.Container, npf.ui.RenderComponent);
 ...
 * @private
 */
npf.ui.Container.prototype.state_ = 0x00;
 ...
 * @private
 */
npf.ui.Container.prototype.supportedStates_ = 0x00;
 ...
 * @private
 */
npf.ui.Container.prototype.autoStates_ = goog.ui.Component.State.ALL;
 ...
 * @private
 */
npf.ui.Container.prototype.statesWithTransitionEvents_ = 0x00;
 ...
 * @private
 */
npf.ui.Container.prototype.visible_ = true;
 ...
 * @private
 */
npf.ui.Container.prototype.keyHandler_;
 ...
 * @private
 */
npf.ui.Container.prototype.handleMouseEvents_ = true;
 ...
 * @private
 */
npf.ui.Container.prototype.allowTextSelection_ = false;
...
/** @inheritDoc */
npf.ui.Container.prototype.createDom = function() {
 ...
 * @override
 */
npf.ui.Container.prototype.decorateInternal = function(element) {
...
/** @inheritDoc */
npf.ui.Container.prototype.enterDocument = function() {
  ...
  this.getRenderer().initializeDom(this);
 ...
 */
npf.ui.Container.prototype.isHandleMouseEvents = function() {
 ...
 */
npf.ui.Container.prototype.setHandleMouseEvents = function(enable) {
 ...
 *     events.
 */
npf.ui.Container.prototype.getKeyEventTarget = function() {
  return this.getRenderer().getKeyEventTarget(this);
};
 ...
 * @protected
 */
npf.ui.Container.prototype.getKeyHandler = function() {
...
/**
 * Returns the component's preferred ARIA role. This can be used by a component to
...
/**
 * Sets the component's preferred ARIA role. This can be used to override the role
 ...
 * @private
 */
npf.ui.Container.prototype.enableMouseEventHandling_ = function(enable) {
  ...
  if (enable) {
    handler
      .listen(hoverableElement, goog.events.EventType.MOUSEOVER, this.handleMouseOver)
      ...
      .listen(hoverableElement, goog.events.EventType.MOUSEOUT, this.handleMouseOut);
    ...
    handler
      .unlisten(hoverableElement, goog.events.EventType.MOUSEOVER, this.handleMouseOver)
      ...
      .unlisten(hoverableElement, goog.events.EventType.MOUSEOUT, this.handleMouseOut);
 ...
 * removes event handlers.  Overrides {@link npf.ui.RenderComponent#exitDocument}
 * by making sure that components that are removed from the document aren't
 * focusable (i.e. have no tab index).
 * @override
 */
npf.ui.Container.prototype.exitDocument = function() {
...
/** @override */
npf.ui.Container.prototype.disposeInternal = function() {
...
/** @override */
npf.ui.Container.prototype.setRightToLeft = function(rightToLeft) {
  ...
  if (element) {
    this.getRenderer().setRightToLeft(element, rightToLeft);
  }
};
 ...
 */
npf.ui.Container.prototype.isAllowTextSelection = function() {
 ...
 */
npf.ui.Container.prototype.setAllowTextSelection = function(allow) {
  this.allowTextSelection_ = allow;

  var element = this.getElement();

  if (element) {
    this.getRenderer().setAllowTextSelection(element, allow);
  }
};
 ...
 */
npf.ui.Container.prototype.isVisible = function() {
 ...
 */
npf.ui.Container.prototype.setVisible = function(visible, opt_force) {
  if (opt_force || (this.visible_ != visible && this.dispatchEvent(visible ?
    ...
    if (element) {
      this.getRenderer().setVisible(element, visible);
    }

    if (this.isEnabled()) {
      this.getRenderer().setFocusable(this, visible);
    }
 ...
 */
npf.ui.Container.prototype.isEnabled = function() {
 ...
 */
npf.ui.Container.prototype.setEnabled = function(enable) {
  if (this.isTransitionAllowed(goog.ui.Component.State.DISABLED, !enable)) {
    ...
    if (this.isVisible()) {
      this.getRenderer().setFocusable(this, enable);
    }
 ...
 */
npf.ui.Container.prototype.isHighlighted = function() {
 ...
 * @see #isTransitionAllowed
 */
npf.ui.Container.prototype.setHighlighted = function(highlight) {
 ...
 */
npf.ui.Container.prototype.isActive = function() {
 ...
 * @see #isTransitionAllowed
 */
npf.ui.Container.prototype.setActive = function(active) {
 ...
 */
npf.ui.Container.prototype.isSelected = function() {
 ...
 * @see #isTransitionAllowed
 */
npf.ui.Container.prototype.setSelected = function(select) {
 ...
 */
npf.ui.Container.prototype.isChecked = function() {
 ...
 * @see #isTransitionAllowed
 */
npf.ui.Container.prototype.setChecked = function(check) {
 ...
 *     keyboard focus.
 */
npf.ui.Container.prototype.isFocused = function() {
 ...
 */
npf.ui.Container.prototype.setFocused = function(focused) {
 ...
 */
npf.ui.Container.prototype.isOpen = function() {
 ...
 * @see #isTransitionAllowed
 */
npf.ui.Container.prototype.setOpen = function(open) {
 ...
 */
npf.ui.Container.prototype.getState = function() {
  return this.state_;
};
 ...
 */
npf.ui.Container.prototype.hasState = function(state) {
 ...
 */
npf.ui.Container.prototype.setState = function(state, enable) {
  if (this.isSupportedState(state) && enable != this.hasState(state)) {
    // Delegate actual styling to the renderer, since it is DOM-specific.
    this.getRenderer().setState(this, state, enable);
 ...
 * @protected
 */
npf.ui.Container.prototype.setStateInternal = function(state) {
  this.state_ = state;
};
 ...
 */
npf.ui.Container.prototype.isSupportedState = function(state) {
 ...
 * @throws {Error} If disabling support for a state the component is currently in.
 */
npf.ui.Container.prototype.setSupportedState = function(state, support) {
 ...
 *     the state.
 */
npf.ui.Container.prototype.isAutoState = function(state) {
 ...
 */
npf.ui.Container.prototype.setAutoStates = function(states, enable) {
 ...
 *     the state.
 */
npf.ui.Container.prototype.isDispatchTransitionEvents = function(state) {
 ...
 */
npf.ui.Container.prototype.setDispatchTransitionEvents = function(states,
    enable) {
 ...
 *     transitioning.
 * @param {boolean} enable Whether the component is entering or leaving the state.
 * @return {boolean} Whether the state transition is allowed to proceed.
 * @protected
 */
npf.ui.Container.prototype.isTransitionAllowed = function(state, enable) {
 ...
 */
npf.ui.Container.prototype.handleMouseDown = function(e) {
  if (this.isEnabled()) {
    ...
    if (e.isMouseActionButton()) {
      ...
      if (this.getRenderer().isFocusable(this)) {
 ...
 * @param {goog.events.Event} e Mouse event to handle.
 */
npf.ui.Container.prototype.handleMouseUp = function(e) {
  if (this.isEnabled()) {
    if (this.isAutoState(goog.ui.Component.State.HOVER)) {
      this.setHighlighted(true);
    }
 ...
 * @param {goog.events.Event} e Mouse event to handle.
 */
npf.ui.Container.prototype.handleDblClick = function(e) {
  if (this.isEnabled()) {
    this.performActionInternal(e);
  }
};
 ...
 * @protected
 */
npf.ui.Container.prototype.performActionInternal = function(e) {
 ...
 */
npf.ui.Container.prototype.handleFocus = function(e) {
 ...
 */
npf.ui.Container.prototype.handleBlur = function(e) {
  if (this.isAutoState(goog.ui.Component.State.ACTIVE)) {
    this.setActive(false);
  }
 ...
 */
npf.ui.Container.prototype.handleKeyEvent = function(e) {
  if (
 ...
 * @protected
 */
npf.ui.Container.prototype.handleKeyEventInternal = function(e) {
