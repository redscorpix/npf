...
npf.ui.form.Password = function(name, opt_renderer, opt_domHelper) {
	goog.base(this, name, opt_renderer || npf.ui.form.PasswordRenderer.getInstance(), opt_domHelper);
};
 ...
 */
npf.ui.form.Password.prototype.addCompareValidator = function(passwordField, opt_error) {
