...
npf.ui.scrollBar.SizeMonitor = function(parentElement, opt_domHelper) {
	...
	goog.events.listen(resizeTarget, goog.events.EventType.RESIZE, this._handleResize, false, this);
...
npf.ui.scrollBar.SizeMonitor.prototype.disposeInternal = function() {
	...
	goog.events.unlisten(this.resizeTarget_, goog.events.EventType.RESIZE, this._handleResize, false, this);
 ...
 * @private
 */
npf.ui.scrollBar.SizeMonitor.prototype._handleResize = function(e) {
