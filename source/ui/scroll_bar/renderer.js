 ...
 * @private
 */
npf.ui.scrollBar.Renderer._scrollBarWidth;
...
npf.ui.scrollBar.Renderer.getScrollBarWidth = function() {
	if (!goog.isDef(npf.ui.scrollBar.Renderer._scrollBarWidth)) {
		npf.ui.scrollBar.Renderer._scrollBarWidth = goog.style.getScrollbarWidth();
	}

	return npf.ui.scrollBar.Renderer._scrollBarWidth;
};
...
npf.ui.scrollBar.Renderer.prototype.createDom = function(container) {
	...
	/** @type {!Element} */
	var containerElement = goog.dom.createDom(goog.dom.TagName.DIV, this.getContainerCssClass());
	/** @type {!Element} */
	var contentWrapperElement = goog.dom.createDom(goog.dom.TagName.DIV, this.getContentWrapperCssClass());
	/** @type {!Element} */
